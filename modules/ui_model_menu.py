    ...
    with gr.Tab("Model", elem_id="model-tab"):
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                shared.gradio['download_specific_file'] = gr.Textbox(placeholder="File name (for GGUF models)", show_label=False, max_lines=1, visible=False)
                with gr.Row():
...
def create_event_handlers():
    ...
    shared.gradio['model_menu'].change(
        ...
        load_model_wrapper, gradio('model_menu', 'loader'), gradio('model_status'), show_progress=False).success(
    ...
    #shared.gradio['get_file_list'].click(partial(download_model_wrapper, return_links=True), gradio('custom_model_menu'), gradio('model_status'), show_progress=True)
